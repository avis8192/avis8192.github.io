...
import ask from './components/ask.jpeg';
...
function App() {
  ...
  return (
    <div className="App absolute w-screen h-screen">
      ...
      <img id="kalp" src={heart} onClick={ToggleClasss} className={isActives ? "null" : "changes"}></img>
      <div className={isActives ? "null" : "changes"}>
          <div className="menus w-full z-20 left-full h-full flex flex-col justify-center items-center absolute opacity-90 bg-black">
              <img src={ask} className="foto"></img>
              <h1 class="text-white -mt-20 text-3xl">&lt;∞</h1>
              <img className='geridon w-8 h-8' src={back} onClick={ToggleClasss}></img>
          </div>
      </div>
