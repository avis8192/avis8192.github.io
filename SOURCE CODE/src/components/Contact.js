...
function Contact(lang) {
  ...
  var veya = "";
    ...
    if(lang === 'en'){
      ...
      discord = <div className="flex">Click for <a className="text-teal-500 pl-2" href="https://discord.com/users/935066602037203015"> discord.</a></div>  
      mail = <div className="flex">Click for <a className="text-teal-500 pl-2" href="mailto:barancevikoglu8192@gmail.com"> mail.</a></div>
    }
    if(lang === 'tr'){
      veya = "veya";
      baslik = "Bana ulaşın:";
      yazi = "Burada iletişim bilgilerimizi bulabilirsiniz";
      discord = <div className="flex">Discord için <a className="text-teal-500 pl-2" href="https://discord.com/users/935066602037203015"> tıklayın.</a></div>
      mail = <div className="flex">E-Posta için <a className="text-teal-500 pl-2" href="mailto:barancevikoglu8192@gmail.com"> tıklayın.</a></div>
    }
  return (
